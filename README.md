###Console application that simulates a simple bank. Application is connected to a database and provides a Javalin-based API for web requests. It contains two controllers with CRUD requests.
